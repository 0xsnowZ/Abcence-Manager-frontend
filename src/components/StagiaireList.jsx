                    ...
                    <tr key={stagiaire.id} className="transition-all">
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          <div
                            className={`avatar-circle avatar-md me-3 ${["f", "F"].includes(stagiaire.sexe)
                      ...
                      <td className="text-center">
                        <span
                          className={`badge rounded-pill px-3 py-1 ${getAbsenceCount(stagiaire.id) > 0
                ...
                <ul className="pagination pagination-sm mb-0 shadow-sm border rounded">
                  ...
                  {[...Array(totalPages)].map((_, i) => (
                    <li key={i + 1} className={`page-item ${currentPage === i + 1 ? "active" : ""}`}>
                      <button
                        className={`page-link border-0 ${currentPage === i + 1 ? "bg-dark-navy text-white" : "text-dark"
                          }`}
